...
Acceleration3D computeAccel3D(Mass mass, const Force3D &force) 
{
...
Velocity3D computeVelo3D(Acceleration3D &accel, Velocity3D &prevVelo, Time deltaT) 
{
...
Position3D computePos3D(Velocity3D &velo, Position3D &prevPos, Time deltaT) 
{
